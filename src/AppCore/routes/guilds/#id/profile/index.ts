...
app.get(
    ...
    async (
        ...
        fetch(`https://canary.discord.com/api/v9/guilds/${req.params.id}?with_counts=true`, {
            method: "GET",
...
const callbackEditCurrentGuild = (
    ...
    fetch(`https://canary.discord.com/api/v10/guilds/${guildId}`, {
        headers: {
...
const callbackEditCurrentMember = (
    ...
    fetch(`https://canary.discord.com/api/v10/guilds/${guildId}/members/@me`, {
        headers: {
            authorization: reqCallback.headers.authorization,
            "user-agent": Constants.UserAgentDiscordBot,
            "Content-Type": "application/json",
